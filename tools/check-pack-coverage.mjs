...
if (!atlasPath || !worldArg || !enemyBaseArg) {
  console.error("Usage: node tools/check-pack-coverage.mjs path/to/tiles.json --world=src/world-data.js --enemybase=public/data/enemybase2.txt [--fail-on-missing] [--max-items=80]");
  process.exit(1);
}
